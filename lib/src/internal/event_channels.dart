...
void _setDidStartSessionCompletion(void Function()? completion) {
  ...
  _eventChannel('didStartSessionEvent', (msg) => _didStartSessionCompletion?.call());
}
...
void _setDidEndSessionCompletion(void Function()? completion) {
  ...
  _eventChannel('didEndSessionEvent', (msg) => _didEndSessionCompletion?.call());
}
...
void _setDidStartRestoreSessionCompletion(void Function()? completion) {
  ...
  _eventChannel('didStartRestoreSessionEvent', (msg) => _didStartRestoreSessionCompletion?.call());
}
...
void _setDidContinueRemoteSessionCompletion(void Function()? completion) {
  ...
  _eventChannel('didContinueRemoteSessionEvent', (msg) => _didContinueRemoteSessionCompletion?.call());
}
